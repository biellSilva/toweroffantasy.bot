...
import discord
from adapters.discord.embeds import relics as embeds
...
class RelicsView(discord.ui.View):
    def __init__(
        ...
        *,
        ...
        self.add_item(RelicsDropdown(owner=owner, data=data))


class RelicsDropdown(discord.ui.Select[Any]):
    def __init__(
        self,
        *,
        data: "Relic",
            ...
            sorted(
                {
                    ...
                    "advancements": embeds.advacements_embed,
                }.items()
            )
        )

        super().__init__(
            custom_id="relics_dropdown",
