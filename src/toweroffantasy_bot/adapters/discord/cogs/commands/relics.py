...
from adapters.discord.views.relics import RelicsView
from discord import Interaction, app_commands
from discord.app_commands import Choice
from discord.ext import commands
from infra.repositories.relics import RelicsRepository
from unidecode import unidecode

from ...embeds.relics import info_embed


@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
class RelicsCog(
    commands.GroupCog, group_name="relics", description="Mounts group command"
):
    def __init__(self, bot: commands.Bot):
        self.bot = bot
        self.repository = RelicsRepository()
