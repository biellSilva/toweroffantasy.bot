...
from bot.config import SIMULACRA_DATA, MATRICES_DATA, RELICS_DATA, MOUNTS_DATA, SERVANTS_DATA 
                ...
                if res.status == 200:
                    ...
                    for data_file in dict_data:
                        ...
                        if folder == 'simulacra':
                            ...
                            if simulacra_dict and weapon_dict and matrice_dict:
                    ...
                    _log_cache.info(f'- Synced {folder} | {len(dict_data)}')
